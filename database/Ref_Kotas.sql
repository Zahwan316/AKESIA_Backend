...
--
-- Host: localhost:3306
-- Generation Time: May 02, 2025 at 02:31 PM
...
--
-- Table structure for table `Ref_Kotas`
--

CREATE TABLE `Ref_Kotas` (
...
--
-- Dumping data for table `Ref_Kotas`
--

INSERT INTO `Ref_Kotas` (`id`, `provinsi_id`, `name`, `created_at`, `updated_at`) VALUES
